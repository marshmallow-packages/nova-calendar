...
-   check out the project's [GitHub page](https://github.com/marshmallow-packages/nova-calendar) where we talk about possible enhancements, new features and implementation strategies.
...
-   realise that your pull request may be rejected, merged as is or merged after changes at the discretion of the project maintainer [marshmallow](https://github.com/marshmallow-packages).
...
For any questions, doubts or remarks you have, please create a [discussion](https://github.com/marshmallow-packages/nova-calendar/discussions) on GitHub and we'll discuss your thoughts there :).
...
1. Open your project's `phpunit.xml` and add the following entry to the `<testsuites>` node:
    ...
    <testsuite name="NovaCalendar">
      <directory suffix="Test.php">./vendor/marshmallow/nova-calendar</directory>
    </testsuite>
    ```
