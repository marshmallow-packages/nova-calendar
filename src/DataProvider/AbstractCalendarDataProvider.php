...
namespace Marshmallow\NovaCalendar\DataProvider;
...
use Marshmallow\NovaCalendar\Contracts\EventFilterInterface as EventFilter;
use Marshmallow\NovaCalendar\EventGenerator\NovaEventGenerator;
use Marshmallow\NovaCalendar\NovaCalendar;
use Marshmallow\NovaCalendar\CalendarDay;
...
abstract class AbstractCalendarDataProvider implements CalendarDataProviderInterface
{
    ...
    private function loadAllEvents(): void
    {
        ...
        if ($this->activeFilterKey) {
            ...
            if ($filter) {
                $this->allEvents = array_filter($this->allEvents, function ($event) use ($filter) {
                    return $filter->showEvent($event);
                });
            } else {
